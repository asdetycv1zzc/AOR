...
func Catalog() []ProviderCatalog {
	...
	return cloneCatalog([]ProviderCatalog{
		...
		},
		{
			...
			Models: []CatalogModel{
				{ID: "claude-sonnet-4-5", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-sonnet-4-6", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-sonnet-4-7", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-sonnet-4-8", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-sonnet-5", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-opus-4-1", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-opus-4-5", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-opus-4-6", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-opus-4-7", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-opus-4-8", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-opus-5", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-fable-5", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
				{ID: "claude-haiku-4-5", MaxInput: 200000, MaxOutput: 8192, ToolCalls: true, JSONSchema: true, Streaming: true},
			},
		},
		{
