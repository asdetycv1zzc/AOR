...
func (preparer *AuthoritativePreparer) Prepare(ctx context.Context, request Request, project state.Project) (prepared PreparedRun, err error) {
	...
	prepared = PreparedRun{
		...
		ModelCall: agentruntime.ModelCall{
			...
			ReasoningEffort: route.ReasoningEffort, ContextWindowTokens: route.ContextWindowTokens, CompactionThresholdTokens: route.CompactionThresholdTokens, MaxOutputTokens: route.MaxOutputTokens, ThinkingBudget: route.ThinkingBudget, Temperature: route.Temperature, Seed: cloneGlobalAuditSeed(route.Seed),
