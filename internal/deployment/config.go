...
func ValidateCompose(input []byte) error {
	...
	if !hasReadOnlyVolume(worker.Volumes, "AOR_KNOWLEDGE_HOST_PATH", "/var/lib/aor/knowledge") || !hasVolume(worker.Volumes, "AOR_PROJECTS_HOST_PATH", "/var/lib/aor/repositories") {
		return ErrInvalidDeployment
	}
