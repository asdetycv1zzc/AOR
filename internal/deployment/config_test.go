...
func TestDeploymentProfilesFailClosed(t *testing.T) {
	...
	for _, value := range []string{
		...
		"000017_relational_projection_sync.up.sql", "000018_repository_submissions.up.sql", "000019_model_usage_reconciliation.up.sql", "000020_repository_registry.up.sql", "000021_event_replay_state.up.sql", "000022_project_agent_leases.up.sql",
